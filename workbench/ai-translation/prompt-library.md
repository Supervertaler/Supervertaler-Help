...
| 4 | **Image Context** | Visual references for the AI. Images loaded via the **✨ AI → 🖼️ Image Context** tab are sent as binary data alongside your prompt when figure references (Fig. 1, Figure 2A, …) are detected in a segment. |
