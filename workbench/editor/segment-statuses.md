...
| Status | Icon | Meaning |
|--------|------|---------|
| **PM (102%)** | <span style="background:#546E7A;color:#fff;border-radius:3px;padding:1px 6px;font-size:0.85em;font-weight:bold;">PM</span> | **Perfect Match.** The segment matches a TM entry with identical context (surrounding segments). The highest level of TM confidence. |
| **CM (101%)** | <span style="background:#2E7D32;color:#fff;border-radius:3px;padding:1px 6px;font-size:0.85em;font-weight:bold;">CM</span> | **Context Match.** A 100% TM match where the preceding segment context also matches. |
...
Perfect Match and Context Match are shown as small coloured **PM** and **CM** text badges in the status column, mirroring the way Trados Studio labels them, rather than as emoji icons.
