...
| Status | Icon | Meaning |
|--------|------|---------|
| **PM (102%)** | **PM** badge (blue-grey) | **Perfect Match.** The segment matches a TM entry with identical context (surrounding segments). The highest level of TM confidence. |
| **CM (101%)** | **CM** badge (green) | **Context Match.** A 100% TM match where the preceding segment context also matches. |
