...
This creates a term entry where source and target are the same. Non-translatable terms appear as **yellow** chips in [TermLens](/trados/termlens/), the [TermLens popup](/trados/termlens/termlens-popup/) and [TermPicker](/trados/termlens/termpicker/).
