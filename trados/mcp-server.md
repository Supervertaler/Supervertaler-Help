...
**Give each chat one line that names its Studio, and it works only in that one.** In Claude Desktop, *Projects → Project instructions*, put in the 2026 chat's project:
