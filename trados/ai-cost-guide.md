...
* [Token Usage & Costs](/trados/usage-costs/) – the persistent usage log, the Usage & Costs report, CSV/Excel export, and the monthly budget
* [AI Settings](/trados/settings/ai-settings/) – configure your API keys and choose a model
* [Batch Translate](/trados/batch-translate/) – translate segments in bulk
* [AI Proofreader](/trados/ai-proofreader/) – proofread translated segments
* [AutoPrompt](/trados/generate-prompt/) – generate translation prompts
* [Licensing & Pricing](/trados/licensing/) – Supervertaler subscription plans
